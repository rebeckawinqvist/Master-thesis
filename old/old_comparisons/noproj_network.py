...
if __name__ == "__main__":
    ...
    if to_train:
        ...
        torch.save(NN.state_dict(), filename+'noproj_network_model_ntrain_{}_nepochs_{}.pt'.format(nsamples_train, nepochs))
    else:
        NN.load_state_dict(torch.load('ex{}/ex{}_noproj_network_model_ntrain_{}_nepochs_{}.pt'.format(example, example, nsamples_train, nepochs)))
    ...
    np.savetxt(filename+'noproj_test_mse_losses_ntrain_{}_ntest_{}_nepochs_{}_NEW.csv'.format(nsamples_train, nsamples_test, nepochs), mse_arr, delimiter=',')
    np.savetxt(filename+'noproj_test_nmse_losses_ntrain_{}_ntest_{}_nepochs_{}_NEW.csv'.format(nsamples_train, nsamples_test, nepochs), nmse_arr, delimiter=',')
    np.savetxt(filename+'noproj_true_values_ntrain_{}_ntest_{}_nepochs_{}_NEW.csv'.format(nsamples_train, nsamples_test, nepochs), true_values_arr, delimiter=',')
    ...
    plt.xlabel(xlabel)
    plt.ylabel(ylabel)
    filen_fig = filename+"noproj_difficulty_points_ntrain_{}_ntest_{}_nepochs_{}_NEW.png".format(nsamples_train, nsamples_test, nepochs)
    ...
    filen_fig = filename+"noproj_test_mse_losses_ntrain_{}_ntest_{}_nepochs_{}_NEW.png".format(nsamples_train, nsamples_test, nepochs)
    plt.savefig(filen_fig)
    plt.show()
    ...
    filen_fig = filename+"noproj_test_nmse_losses_ntrain_{}_ntest_{}_nepochs_{}_NEW.png".format(nsamples_train, nsamples_test, nepochs)
    plt.savefig(filen_fig)
    plt.show()
    ...
    if to_train:
        # plot train losses
        np.savetxt(filename+'noproj_train_losses_ntrain_{}_ntest_{}_nepochs_{}.csv'.format(nsamples_train, nsamples_test, nepochs), epochs_arr, delimiter=',')
        ...
        filen_fig = filename+"noproj_train_losses_ntrain_{}_ntest_{}_nepochs_{}.png".format(nsamples_train, nsamples_test, nepochs)
        plt.savefig(filen_fig)
        plt.show()
