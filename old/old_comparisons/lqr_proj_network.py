...
if __name__ == "__main__":
    ...
    if to_train:
        ...
        NN.load_state_dict(torch.load('ex{}/ex{}_lqr_proj_network_model_ntrain_{}_nepochs_{}.pt'.format(example, example, nsamples_train, nepochs)))
    ...
    np.savetxt(filename+'lqr_test_mse_losses_ntrain_{}_ntest_{}_nepochs_{}_NEW.csv'.format(nsamples_train, nsamples_test, nepochs), mse_arr, delimiter=',')
    np.savetxt(filename+'lqr_test_nmse_losses_ntrain_{}_ntest_{}_nepochs_{}_NEW.csv'.format(nsamples_train, nsamples_test, nepochs), nmse_arr, delimiter=',')
    np.savetxt(filename+'lqr_true_values_ntrain_{}_ntest_{}_nepochs_{}_NEW.csv'.format(nsamples_train, nsamples_test, nepochs), true_values_arr, delimiter=',')
    ...
    plt.xlabel(xlabel)
    plt.ylabel(ylabel)
    filen_fig = filename+"lqr_difficulty_points_ntrain_{}_ntest_{}_nepochs_{}_NEW.png".format(nsamples_train, nsamples_test, nepochs)
    ...
    filen_fig = filename+"lqr_test_mse_losses_ntrain_{}_ntest_{}_nepochs_{}_NEW.png".format(nsamples_train, nsamples_test, nepochs)
    plt.savefig(filen_fig)
    plt.show()
    ...
    filen_fig = filename+"lqr_test_nmse_losses_ntrain_{}_ntest_{}_nepochs_{}_NEW.png".format(nsamples_train, nsamples_test, nepochs)
    plt.savefig(filen_fig)
    plt.show()
