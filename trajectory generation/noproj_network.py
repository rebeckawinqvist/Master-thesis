...
if __name__ == "__main__":
    ...
    np.savetxt(filename+'noproj_test_mse_losses.csv', mse_arr, delimiter=',')
    np.savetxt(filename+'noproj_test_nmse_losses.csv', nmse_arr, delimiter=',')
    np.savetxt(filename+'noproj_train_losses.csv', epochs_arr, delimiter=',')
    ...
    plt.xlabel(xlabel)
    plt.ylabel(ylabel)
    filen_fig = filename+"noproj_difficulty_points.png"
    ...
    filen_fig = filename+"noproj_train_losses.png"
    plt.savefig(filen_fig)
    plt.show()
    ...
    filen_fig = filename+"noproj_test_mse_losses.png"
    plt.savefig(filen_fig)
    plt.show()
    ...
    filen_fig = filename+"noproj_test_nmse_losses.png"
    plt.savefig(filen_fig)
    plt.show()
