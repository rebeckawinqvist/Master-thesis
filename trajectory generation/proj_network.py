...
if __name__ == "__main__":
    ...
    torch.save(NN.state_dict(), 'ex{}/{}/networks/ex{}_proj_network_model.pt'.format(example, date, example))
    ...
    np.savetxt('ex{}/{}/true_values/ex{}_true_values.csv'.format(example, date, example), true_values_arr, delimiter=',')
    ...
    plt.xlabel(xlabel)
    plt.ylabel(ylabel)
    filen_fig = "ex{}/{}/plots/ex{}_proj_difficulty_points.png".format(example, date, example)
    ...
    filen_fig = "ex{}/{}/train_losses/ex{}_proj_train_losses.png".format(example, date, example)
    plt.savefig(filen_fig)
    plt.show()
    ...
    filen_fig = "ex{}/{}/test_losses/ex{}_proj_test_mse_losses.png".format(example, date, example)
    plt.savefig(filen_fig)
    plt.show()
