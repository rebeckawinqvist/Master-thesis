...
if __name__ == "__main__":
    ...
    filename_trajs = "ex{}/d{}/trajectories/".format(example, date)
    filename_evals = "ex{}/d{}/evaluations/ex{}_".format(example, date, example)
    filename_costs = "ex{}/d{}/cost_dicts/".format(example, date)
