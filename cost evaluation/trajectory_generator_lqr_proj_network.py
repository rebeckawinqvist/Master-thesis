...
if __name__ == "__main__":
    ...
    print(os.getcwd())
    #A = np.loadtxt('{}/ex{}/{}/ex{}_A.csv'.format(os.getcwd(),example, date, example), delimiter=',')
    NN = Network([8,8])
    NN.load_state_dict(torch.load("ex{}/d{}/networks/ex{}_lqr_proj_network_model_new.pt".format(example, date, example)))
