...
if __name__ == "__main__":
    ...
    if to_train:
        ...
        torch.save(NN.state_dict(), filename+'proj_network_model_ntrain_{}_nepochs_{}.pt'.format(nsamples_train, nepochs))
        epochs_arr = np.array(epochs_losses)
    else:
        NN.load_state_dict(torch.load('ex{}/ex{}_proj_network_model_ntrain_{}_nepochs_{}.pt'.format(example, example, nsamples_train, nepochs)))
    ...
    np.savetxt(filename+'test_mse_losses_ntrain_{}_ntest_{}_nepochs_{}_NEW.csv'.format(nsamples_train, nsamples_test, nepochs), mse_arr, delimiter=',')
    np.savetxt(filename+'test_nmse_losses_ntrain_{}_ntest_{}_nepochs_{}_NEW.csv'.format(nsamples_train, nsamples_test, nepochs), nmse_arr, delimiter=',')
    np.savetxt(filename+'true_values_ntrain_{}_ntest_{}_nepochs_{}_NEW.csv'.format(nsamples_train, nsamples_test, nepochs), true_values_arr, delimiter=',')
    ...
    plt.xlabel(xlabel)
    plt.ylabel(ylabel)
    filen_fig = filename+"difficulty_points_ntrain_{}_ntest_{}_nepochs_{}_NEW.png".format(nsamples_train, nsamples_test, nepochs)
    ...
    filen_fig = filename+"test_mse_losses_ntrain_{}_ntest_{}_nepochs_{}_NEW.png".format(nsamples_train, nsamples_test, nepochs)
    plt.savefig(filen_fig)
    plt.show()
    ...
    filen_fig = filename+"test_nmse_losses_ntrain_{}_ntest_{}_nepochs_{}_NEW.png".format(nsamples_train, nsamples_test, nepochs)
    plt.savefig(filen_fig)
    plt.show()    
    ...
    if to_train:
        ...
        filen_fig = filename+"train_losses_ntrain_{}_ntest_{}_nepochs_{}.png".format(nsamples_train, nsamples_test, nepochs)
        #plt.savefig(filen_fig)
        plt.show()