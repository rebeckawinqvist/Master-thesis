...
if __name__ == "__main__":
    ...
    plt.xlabel(xlabel)
    plt.ylabel(ylabel)
    filen_fig = filename+data_generation+"_bad_good_points_lqr_projNN.png"
    ...
    filen_fig = filename+data_generation+"_epochs_{}_lqr_projNN.png".format(num_epochs)
    plt.savefig(filen_fig)
    plt.show()
    ...
    filen_fig = filename+data_generation+"_epochs_{}_test_losses_lqr_projNN.png".format(num_epochs)
    plt.savefig(filen_fig)
    plt.show()
