...
initial_states = np.loadtxt('initial_states.csv', delimiter=',')
...
for row in initial_states:
  ...
  l_flat = l.flatten()
  u_flat = u.flatten()
  #in_data = np.concatenate((P_flat, A_flat, q_flat, l_flat, u_flat, x0))
  in_data = x0
  feed_data[i,:] = in_data
...
savetxt('input_data_small.csv', feed_data, delimiter = ',')
savetxt('output_data_small.csv', result_data, delimiter = ',')