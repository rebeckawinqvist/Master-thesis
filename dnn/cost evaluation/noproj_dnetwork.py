...
if __name__ == "__main__":
    ...
    torch.save(NN.state_dict(), 'ex{}/{}/networks/ex{}_dnn_network_model.pt'.format(example, date, example))
    ...
    np.savetxt(filename_test+'dnn_test_mse_losses.csv', mse_arr, delimiter=',')
    #np.savetxt(filename+'noproj_test_nmse_losses.csv', nmse_arr, delimiter=',')
    np.savetxt(filename_train+'dnn_train_losses.csv', epochs_arr, delimiter=',')
    np.savetxt('ex{}/{}/true_values/ex{}_dnn_true_values.csv'.format(example, date, example), true_values_arr, delimiter=',')
    ...
    plt.xlabel(xlabel)
    plt.ylabel(ylabel)
    filen_fig = "ex{}/{}/plots/ex{}_dnn_difficulty_points.png".format(example, date, example)
    ...
    filen_fig = "ex{}/{}/train_losses/ex{}_dnn_train_losses.png".format(example, date, example)
    plt.savefig(filen_fig)
    plt.show()
    ...
    filen_fig = "ex{}/{}/test_losses/ex{}_dnn_test_mse_losses.png".format(example, date, example)
    plt.savefig(filen_fig)
    plt.show()
