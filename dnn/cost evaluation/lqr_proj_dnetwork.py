...
if __name__ == "__main__":
    ...
    torch.save(NN.state_dict(), 'ex{}/{}/networks/ex{}_lqr_pdnn_network_model.pt'.format(example, date, example))
    ...
    np.savetxt(filename_test+'lqr_pdnn_test_mse_losses.csv', mse_arr, delimiter=',')
    np.savetxt(filename_train+'lqr_pdnn_train_losses.csv', epochs_arr, delimiter=',')
    np.savetxt('ex{}/{}/true_values/ex{}_lqr_pdnn_true_values.csv'.format(example, date, example), true_values_arr, delimiter=',')
    ...
    plt.xlabel(xlabel)
    plt.ylabel(ylabel)
    filen_fig = "ex{}/{}/plots/ex{}_lqr_pdnn_difficulty_points.png".format(example, date, example)
    ...
    filen_fig = "ex{}/{}/train_losses/ex{}_lqr_pdnn_train_losses.png".format(example, date, example)
    plt.savefig(filen_fig)
    plt.show()
    ...
    filen_fig = "ex{}/{}/test_losses/ex{}_lqr_pdnn_test_mse_losses.png".format(example, date, example)
    plt.savefig(filen_fig)
    plt.show()
