...
if __name__ == "__main__":
    ...
    torch.save(NN.state_dict(), 'ex{}/{}/networks/ex{}_pdnn_network_model_ntrain_{}.pt'.format(example, date, example, nsamples_train))
    ...
    np.savetxt(filename_test+'pdnn_test_mse_losses_ntrain_{}.csv'.format(nsamples_train), mse_arr, delimiter=',')
    np.savetxt(filename_train+'pdnn_train_losses_ntrain_{}.csv'.format(nsamples_train), epochs_arr, delimiter=',')
    np.savetxt('ex{}/{}/true_values/ex{}_pdnn_true_values_ntrain_{}.csv'.format(example, date, example, nsamples_train), true_values_arr, delimiter=',')
    ...
    plt.xlabel(xlabel)
    plt.ylabel(ylabel)
    filen_fig = "ex{}/{}/plots/ex{}_pdnn_difficulty_points_ntrain_{}.png".format(example, date, example, nsamples_train)
    ...
    filen_fig = "ex{}/{}/train_losses/ex{}_pdnn_train_losses_ntrain_{}.png".format(example, date, example, nsamples_train)
    plt.savefig(filen_fig)
    plt.show()
    ...
    filen_fig = "ex{}/{}/test_losses/ex{}_pdnn_test_mse_losses_ntrain_{}.png".format(example, date, example, nsamples_train)
    plt.savefig(filen_fig)
    plt.show()
