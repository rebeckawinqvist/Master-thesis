...
if __name__ == "__main__":
    ...
    if to_plot:
        ...
        plt.xlabel(xlabel)
        plt.ylabel(ylabel) 
        filen_fig = "ex{}/initial_states/ex{}_initial_states_{}_{}.png".format(example, example, len(feasible_samples), gen_type)
    ...
    np.savetxt("ex{}/initial_states/ex{}_initial_states_{}_{}.csv".format(example, example, len(feasible_samples), gen_type), feasible_samples, delimiter=",")
